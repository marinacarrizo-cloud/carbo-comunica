...
export default function App() {
  ...
  // CORRECCIÓN DE FECHA: Procesamiento manual de YYYY-MM-DD a DD/MM/YYYY
  ...
  const generarInformeSemanal = () => {
    ...
    ventanaInforme.document.write(`<html><body><pre>INFORME SEMANAL</pre></body></html>`);
  };

  if (!usuarioLogueado) {
    return (
      <div style={{ backgroundColor: '#1e3a8a', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <form onSubmit={handleLogin} style={{ backgroundColor: '#fff', padding: '40px', borderRadius: '12px' }}>

...
Generado automáticamente por el departamento de comunicación del Carbó.`;
  ...
  return (
    <div style={styles.container}>
      {/* HEADER: RUTAS CORREGIDAS PARA QUE ENCUENTREN TUS ARCHIVOS EXACTOS */}
      <header style={styles.header}>
        <div style={styles.headerContent}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            {/* Buscando exactamente escudo.png.png */}
            <img src="/escudo.png.png" alt="Escudo Carbó Oficial" style={styles.logoImg} onError={(e) => { e.target.style.display='none'; e.target.insertAdjacentHTML('afterend', '<span style="color:white;font-size:12px;">(No se encontró el logo)</span>') }} />
            <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            ...
            {/* Buscando exactamente comunicacion.png.jpg */}
            <img src="/comunicacion.png.jpg" alt="Logo Comunicación Oficial" style={styles.logoImg} onError={(e) => { e.target.style.display='none'; e.target.insertAdjacentHTML('afterend', '<span style="color:white;font-size:12px;">(No se encontró el logo)</span>') }} />
          </div>
        </div>
      </header>

      <main style={styles.main}>
        {/* ENLACES OPERATIVOS ORGANIZADOS POR CATEGORÍAS */}
          ...
          <div style={styles.categoriesContainer}>
            <div style={styles.categoryBox}>
              ...
              <div style={styles.linksGroup}>
                <a href="https://enscarbo-cba.infd.edu.ar/sitio/" target="_blank" rel="noreferrer" style={styles.btnSolidBlue}>Web oficial</a>
